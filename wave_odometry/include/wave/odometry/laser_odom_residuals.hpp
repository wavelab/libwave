...
class AnalyticalPointToLine : public ceres::SizedCostFunction<1, 6> {
 public:
    ...
    virtual bool Evaluate(double const *const *parameters,
        ...
        double p_B[3] = {point[0] - ptB[0], point[1] - ptB[1], point[2] - ptB[2]};
        double cross[3];
        ...
        if (jacobians != NULL && jacobians[0][0] != NULL) {
            ...
            // The rotational parts contain the derivative of the coordinate mapping composed with the derivative of the
            // exponential map
