...
struct traits<wave::PoseVelBias> {
    ...
    static wave::PoseVelBias Retract(const wave::PoseVelBias &origin,
        ...
        retval.vel = traits<decltype(retval.vel)>::Retract(origin.vel,
                                                           v.block<6, 1>(6, 0));
        retval.bias = traits<decltype(retval.bias)>::Retract(
          origin.bias, v.block<3, 1>(12, 0));
        return retval;
    }
    ...
    static TangentVector Logmap(const wave::PoseVelBias &m,
        ...
        if (Hm) {
            ...
            retval.block<3, 1>(12, 0).noalias() =
              traits<decltype(m.bias)>::Logmap(m.bias, J3);
    ...
    static wave::PoseVelBias Expmap(const TangentVector &v,
        ...
        if (Hv) {
            ...
            retval.vel =
              traits<decltype(retval.vel)>::Logmap(v.block<6, 1>(6, 0), J2);
            retval.bias =
              traits<decltype(retval.bias)>::Logmap(v.block<3, 1>(12, 0), J3);
            ...
            retval.vel = traits<decltype(retval.vel)>::Logmap(
              v.block<6, 1>(6, 0), boost::none);
            retval.bias = traits<decltype(retval.bias)>::Logmap(
              v.block<3, 1>(12, 0), boost::none);
        }
        return retval;
    }
    ...
    static wave::PoseVelBias Compose(const wave::PoseVelBias &m1,
        ...
        retval.vel =
          traits<decltype(retval.vel)>::Compose(m1.vel, m2.vel, J3, J4);
        retval.bias =
          traits<decltype(retval.bias)>::Compose(m1.bias, m2.bias, J5, J6);
    ...
    static wave::PoseVelBias Between(const wave::PoseVelBias &m1,
        ...
        retval.vel =
          traits<decltype(retval.vel)>::Between(m1.vel, m2.vel, J3, J4);
        retval.bias =
          traits<decltype(retval.bias)>::Between(m1.bias, m2.bias, J5, J6);
