...
struct traits<wave::PoseVelAccBias> {
    ...
    static TangentVector Local(const wave::PoseVelAccBias &origin,
        ...
        retval.block<6, 1>(6, 0).noalias() =
          traits<decltype(origin.vel)>::Local(origin.vel, other.vel);
        retval.block<6, 1>(12, 0).noalias() =
          traits<decltype(origin.acc)>::Local(origin.acc, other.acc);
        retval.block<3, 1>(18, 0).noalias() =
          traits<decltype(origin.bias)>::Local(origin.bias, other.bias);
        return retval;
    }
    ...
    static wave::PoseVelAccBias Retract(const wave::PoseVelAccBias &origin,
        ...
        retval.vel = traits<decltype(retval.vel)>::Retract(
          origin.vel, v.block<6, 1>(6, 0).);
        retval.acc = traits<decltype(retval.acc)>::Retract(
          origin.acc, v.block<6, 1>(12, 0).);
        retval.bias = traits<decltype(retval.bias)>::Retract(
          origin.bias, v.block<3, 1>(18, 0).);
        return retval;
    }
    ...
    static TangentVector Logmap(const wave::PoseVelAccBias &m,
        ...
        if (Hm) {
            ...
            Hm->setZero();
            retval.block<6, 1>(0, 0).noalias() =
              traits<Pose3>::Logmap(m.pose, J1);
            retval.block<6, 1>(6, 0).noalias() =
              traits<decltype(m.vel)>::Logmap(m.vel, J2);
            retval.block<6, 1>(12, 0).noalias() =
              traits<decltype(m.acc)>::Logmap(m.acc, J3);
            retval.block<3, 1>(18, 0).noalias() =
              traits<decltype(m.bias)>::Logmap(m.bias, J4);
            ...
            retval.block<6, 1>(0, 0).noalias() =
              traits<Pose3>::Logmap(m.pose, boost::none);
            retval.block<6, 1>(6, 0).noalias() =
              traits<decltype(m.vel)>::Logmap(m.vel, boost::none);
            retval.block<6, 1>(12, 0).noalias() =
              traits<decltype(m.acc)>::Logmap(m.acc, boost::none);
            retval.block<3, 1>(18, 0).noalias() =
              traits<decltype(m.bias)>::Logmap(m.bias, boost::none);
        }
        return retval;
    }
    ...
    static wave::PoseVelAccBias Expmap(const TangentVector &v,
        ...
        if (Hv) {
            ...
            retval.vel =
              traits<decltype(m.vel)>::Logmap(v.block<6, 1>(6, 0)., J2);
            retval.acc =
              traits<decltype(m.acc)>::Logmap(v.block<6, 1>(12, 0)., J3);
            retval.bias =
              traits<decltype(m.bias)>::Logmap(v.block<3, 1>(18, 0)., J4);
            ...
            retval.pose =
              traits<Pose3>::Expmap(v.block<6, 1>(0, 0)., boost::none);
            retval.vel = traits<decltype(m.vel)>::Logmap(v.block<6, 1>(6, 0).,
                                                         boost::none);
            retval.acc = traits<decltype(m.acc)>::Logmap(v.block<6, 1>(12, 0).,
                                                         boost::none);
            retval.bias = traits<decltype(m.bias)>::Logmap(
              v.block<3, 1>(18, 0)., boost::none);
        }
        return retval;
    }
    ...
    static wave::PoseVelAccBias Compose(const wave::PoseVelAccBias &m1,
        ...
        retval.bias =
          traits<decltype(m.bias)>::Compose(m1.bias, m2.bias, J7, J8);
    ...
    static wave::PoseVelAccBias Between(const wave::PoseVelAccBias &m1,
        ...
        retval.bias =
          traits<decltype(m.bias)>::Between(m1.bias, m2.bias, J7, J8);
