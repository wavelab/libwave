...
#include "wave/vision/vo.hpp"
#include "wave/vision/good.hpp"
#include "wave/vision/fast.hpp"
#include "wave/vision/utils.hpp"
#include "wave/vision/eight_point.hpp"
...
wave::MatX load_data(std::string file_path)
{
    int line_no;
    int nb_lines;
    std::string line;
...
TEST(EightPoint, obtainPose2)
{
    ...
    wave::cvpts2mat(cvpts_1, pts1);
    wave::cvpts2mat(cvpts_2, pts2);
