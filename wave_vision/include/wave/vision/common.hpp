 ...
 * horizontal and vertical plane in radians and image width and height in pixels
 */
...
/**
 * Create projection matrix `P` based on camera intrinsics `K`, camera rotation
 * `R` and camera position `t`
 */
