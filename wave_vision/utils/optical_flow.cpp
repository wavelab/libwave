...
#include "wave/vision/vo/vo.hpp"
#include "wave/vision/features/fast.hpp"
#include "wave/vision/geometry/eight_point.hpp"
...
void extract_roi(wave::Camera &camera, cv::Mat &mask) {
  cv::Mat frame;
...
void feature_extraction(wave::FastDetector &fast,
                        cv::Mat &frame,
...
static void pts2mat(std::vector<cv::Point2f> points, wave::MatX &mat) {
  cv::Point2f p;
...
int main(void) {
  ...
  // wave::MatX epts1;
  // wave::MatX epts2;
  // std::vector<wave::MatX> poses;
  // wave::optimization::EightPoint estimator;
